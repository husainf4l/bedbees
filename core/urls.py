...
urlpatterns = [
    ...
    path(
        "api/accommodation/<int:accommodation_id>/calendar/",
        calendar_api.get_accommodation_calendar,
        name="api_accommodation_calendar",
    ),
    path(
        "api/accommodation/<int:accommodation_id>/calendar/update/",
        calendar_api.update_accommodation_date,
        name="api_update_accommodation_date",
    ),
    path(
        "api/accommodation/<int:accommodation_id>/calendar/bulk-update/",
        calendar_api.bulk_update_accommodation_dates,
        name="api_bulk_update_accommodation",
    ),
    path(
        "api/tour/<int:tour_id>/calendar/",
        calendar_api.get_tour_calendar,
        name="api_tour_calendar",
    ),
    path(
        "api/accommodation/<int:accommodation_id>/availability/",
        calendar_api.get_public_accommodation_availability,
        name="api_public_accommodation_availability",
    ),
    path(
        "api/user/accommodations/",
        calendar_api.get_user_accommodations,
        name="api_user_accommodations",
    ),
    ...
    path(
        "accommodations/<int:id>/",
        views.accommodation_detail,
        name="accommodation_detail",
    ),
    path(
        "accommodations/<int:id>/book/",
        views.book_accommodation,
    ...
    path(
        "create-accommodation/", views.create_accommodation, name="create_accommodation"
    ),
    ...
    path(
        "countries/<str:country>/accommodation/<str:slug>/",
        views.demo_accommodation_detail,
        name="demo_accommodation_detail",
    ),
    path(
        "countries/<str:country>/tour/<str:slug>/",
        views.demo_tour_detail,
        name="demo_tour_detail",
    ),
    path(
        "countries/<str:country>/attraction/<str:slug>/",
    ...
    path(
        ...
        views.bulk_activate_listings,
        name="bulk_activate_listings",
    ),
    path(
        "bulk-deactivate-listings/",
        views.bulk_deactivate_listings,
        name="bulk_deactivate_listings",
    ),
    path(
        "bulk-delete-listings/", views.bulk_delete_listings, name="bulk_delete_listings"
    ),
    path(
        "bulk-publish-listings/",
        views.bulk_publish_listings,
        name="bulk_publish_listings",
    ),
    path(
        "bulk-unpublish-listings/",
        views.bulk_unpublish_listings,
        name="bulk_unpublish_listings",
    ),
    # Individual listing actions
    path(
        "accommodation/<int:listing_id>/view/",
        views.view_accommodation,
        name="view_accommodation",
    ),
    path(
        "accommodation/<int:listing_id>/edit/",
        views.edit_accommodation,
        name="edit_accommodation",
    ),
    path(
        "accommodation/<int:listing_id>/update/",
        views.update_accommodation,
