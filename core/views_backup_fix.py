...
def genius_rewards(request):
    ...
    if genius_profile:
        context.update({
            ...
            'benefits': [
                {'name': f'{genius_profile.discount_percentage}% discount on stays', 'active': True},
                {'name': f'{genius_profile.points_multiplier}x points multiplier', 'active': True},
                {'name': 'Priority customer support', 'active': genius_profile.level >= 2},
